                ...
                <ul className='dropdownMenu dropDownContato'>
                    <li>
                        <a onClick={() => openModal(
                            ...
                            <ContatoModal nome='João Paulo Paiva (Diretor de Compras)' emailPrimario="direcao@compras.ufrn.br" emailSecundario="joao.paulo.paiva@ufrn.br" telefone="(84) 99480-6899" />
