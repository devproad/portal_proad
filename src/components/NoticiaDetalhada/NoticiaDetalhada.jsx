...
const NoticiaDetalhada = () => {
    return (
        <div className='noticiaDetalhada'>
            ...
            Para consulta ao processo, deverá acessar o endereço https://sipac.ufrn.br/public/jsp/portal.jsf no menu Consulta Processos e através do número do processo realizar a consulta.
            </p>
